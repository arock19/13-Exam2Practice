...
def is_prime(n):
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch the above  is_prime  function - it has no TO
...
def practice_problem3d(sequence):
    ...
    ####################################################################
    a = []
    if practice_problem3c(sequence) != a:
